...
public class ItemServiceTest {
    ...
    private User user = new User(200L, "UserFirstName", "UserFirst@yandex.ru");
    private UserDto userDto1 = new UserDto(201L, "AndrewOne", "andrewone@yandex.ru");
    private UserDto userDto2 = new UserDto(202L, "AndrewTwo", "andrewtwo@yandex.ru");
    private ItemDto itemDto = new ItemDto(200L, "ItemFirstName", "ItemFirstDescription", true,
