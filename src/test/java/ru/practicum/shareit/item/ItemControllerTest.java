...
public class ItemControllerTest {
    ...
    private Item item = new Item(1L, "ItemFirstName", "ItemFirstDescription", true, user, null);
    private ItemDto itemDto = new ItemDto(1L, "ItemFirstName", "ItemFirstDescription", true,
            user, null, null, null, null);
    private CommentDto commentDto = new CommentDto(1L, "Comment", item,
