...
public class UserControllerTest {
    ...
    private UserDto userDto = new UserDto(1L, "Andrew", "andrew@yandex.ru");
    private List<UserDto> listUserDto = List.of(
            new UserDto(1L, "AndrewOne", "andrewone@yandex.ru"),
            new UserDto(2L, "AndrewTwo", "andrewtwo@yandex.ru"));
